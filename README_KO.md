...
<p align="center">
  <a href="https://docs.studyield.com">문서</a> |
  <a href="#빠른-시작">빠른 시작</a> |
  <a href="https://github.com/studyield/studyield/discussions">토론</a> |
...
Studyield는 개인화된 콘텐츠, 지능형 튜터링, 적응형 평가를 통해 학생들이 더 효과적으로 학습할 수 있도록 돕는 **오픈 소스 AI 기반 학습 플랫폼**입니다. 학생, 교육자, 평생 학습자를 위해 구축된 Studyield는 최첨단 AI 기술과 검증된 학습 과학을 결합합니다.
...
<p align="center">
  ...
  <br>
  <em>Studyield의 AI 기반 학습 대시보드</em>
</p>

### 작동 방식

1. **자료 업로드** -- 학습 자료(PDF, 문서, 기출문제)를 지식 베이스에 추가
2. **AI 분석 및 정리** -- AI가 핵심 개념을 추출하고 지식 그래프를 구축하며 검색 가능한 임베딩을 생성
3. **연습 및 학습** -- 모의고사를 생성하고, 멀티 에이전트 AI로 문제를 해결하고, 플래시카드로 퀴즈
4. **피드백 받기** -- 티치백 평가를 사용하여 이해도를 테스트하고 지식 격차를 식별
5. **진행 상황 추적** -- 분석을 통해 학습 속도, 숙달 수준, 학습 패턴 모니터링
...
<p align="center">
  <img src=".github/screenshots/ai-chat.png" alt="Studyield AI 채팅" width="800">
  <br>
  <em>AI 채팅 -- 업로드한 학습 자료에 기반한 질문에 문서 인용이 포함된 답변</em>
</p>
...
<p align="center">
  <img src=".github/screenshots/problem-solver.png" alt="Studyield 멀티 에이전트 문제 해결사" width="800">
  <br>
  <em>멀티 에이전트 문제 해결사 -- 분석, 해결, 검증 에이전트가 실시간으로 협력하여 복잡한 문제를 분해하고 검증</em>
</p>

### Studyield의 독특한 점은 무엇인가요?

1. **완전한 AI 학습 생태계** -- 6개의 고급 AI 기능(시험 복제, 멀티 에이전트 해결, 지식 그래프, 티치백, 연구, 코드 샌드박스)이 전통적인 학습 도구(플래시카드, 퀴즈, 노트)와 통합
2. **멀티 에이전트 아키텍처** -- 문제 해결 및 검증을 위한 협업 AI 에이전트를 갖춘 최초의 오픈 소스 학습 플랫폼
3. **자체 호스팅 + 오픈 소스** -- 독점 플랫폼과 달리 Docker 배포를 통해 데이터를 완전히 제어
4. **시험 중심 설계** -- 일반 문제 은행이 아닌 실제 테스트 형식과 일치하는 모의고사 생성
5. **깊은 이해에 중점** -- 티치백 평가 및 다단계 검증을 통해 단순한 암기가 아닌 진정한 이해 보장
...
| 지표 | 상태 | 세부 정보 |
|--------|--------|---------|
| **총 기여자 수** | ![Contributors](https://img.shields.io/github/contributors/studyield/studyield?style=flat-square) | 성장하는 개발자 커뮤니티 |
| **총 커밋 수** | ![Commits](https://img.shields.io/github/commit-activity/t/studyield/studyield?style=flat-square) | 2024년 이후 활발한 개발 |
| **월간 커밋 수** | ![Commit Activity](https://img.shields.io/github/commit-activity/m/studyield/studyield?style=flat-square) | 정기적인 업데이트 및 개선 |
...
| **테스트 커버리지** | ![Coverage](https://img.shields.io/badge/coverage-70%25-green?style=flat-square) | 백엔드 단위 + 통합 테스트 |
| **문서** | ![Docs](https://img.shields.io/badge/docs-comprehensive-blue?style=flat-square) | 전체 API 문서 + 개발자 가이드 |
...
여기에서 귀하의 기여를 보고 싶으신가요? 아래의 [빠른 기여 가이드](#-빠른-기여-가이드)를 확인하세요!
...
이게 전부입니다! `http://localhost:5189`에서 앱에 액세스하고 `http://localhost:3010`에서 API에 액세스합니다.
...
`http://localhost:5189`를 방문하여 앱에 액세스합니다.
...
이렇게 하면 Docker를 통해 PostgreSQL, Redis, Qdrant 및 ClickHouse가 시작된 다음 백엔드 및 프론트엔드 개발 서버가 시작됩니다.
...
**⚡ 빠른 온보딩**
- Docker Compose로 **5분 이내**에 실행 가능
- 명확한 아키텍처를 갖춘 잘 문서화된 코드베이스
- **24-48시간 이내**에 PR에 응답하는 친절한 유지 관리자
- 초보자를 위한 "good first issue" 라벨

## 🗺️ 프로젝트 로드맵

완료된 작업, 진행 중인 작업, 다음 계획에 대한 자세한 내용은 **[미래 목표 및 개발자 브리핑](FUTURE_GOAL.md)**을 참조하세요.
...
💡 **아이디어가 있나요?** [GitHub 토론](https://github.com/studyield/studyield/discussions)을 열거나 기존 스레드에 기여하세요
...
# 백엔드 API: http://localhost:3010
```

**이게 전부입니다!** 이제 Studyield가 로컬에서 실행되고 있습니다.
...
**🟢 초보자 친화적**
- 📝 [오타 수정 또는 문서 개선](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation)
- 🌍 [번역 추가](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Ai18n) -- 12개 언어 지원
- 🐛 [간단한 버그 수정](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- ✨ [UI/UX 개선](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Aui%2Fux)

**🟡 중급**
- 🔌 새로운 AI 에이전트 도구 또는 기능 추가
- 📊 분석 대시보드 및 시각화 개선
- 🧪 [테스트 작성](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Atesting)
- 🚀 [성능 개선](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Aperformance)

**🔴 고급**
- 🤖 새로운 AI 기능 구축 (멀티모달 입력, 고급 추론)
- ⚙️ [핵심 엔진 개선](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Acore)
- 🏗️ [아키텍처 개선](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Aarchitecture)
- 🔐 [보안 기능](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Asecurity)
...
❓ **질문하기** -- 막히면 [토론](https://github.com/studyield/studyield/discussions)에 참여하세요
...
**기여 방법:**
- [GitHub Issues](https://github.com/studyield/studyield/issues)를 통해 버그 보고 또는 기능 요청
...
| 💬 **Discord** | 커뮤니티 참여, 실시간 채팅 | [Discord 참여](https://discord.gg/9JEk6WSM) |
| 🐦 **Twitter/X** | 제품 업데이트, 공지, 팁 | [@infoinletcom](https://x.com/infoinletcom) |
...
보안 취약점은 책임감 있게 보고해 주세요. 공개 정책은 [SECURITY.md](SECURITY.md)를 참조하세요.
...
<p align="center">
  <a href="https://studyield.com">웹사이트</a> |
  <a href="https://docs.studyield.com">문서</a> |
  <a href="https://github.com/studyield/studyield/discussions">토론</a> |
...
<p align="center">
  <strong><a href="https://github.com/studyield">Studyield</a> 커뮤니티가 ❤️로 구축</strong>
</p>

<p align="center">
  이 프로젝트가 유용하다고 생각되시면 별표를 주는 것을 고려해 주세요! ⭐
  <br><br>

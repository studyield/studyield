...
للحصول على معلومات مفصلة حول ما تم إكماله وما هو قيد التنفيذ وما نخطط له بعد ذلك، راجع **[الأهداف المستقبلية وإحاطة المطورين](FUTURE_GOAL.md)**.
...
**🟢 صديق للمبتدئين**
- 📝 [إصلاح الأخطاء الإملائية أو تحسين التوثيق](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation)
- 🌍 [إضافة ترجمات](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Ai18n)
- 🐛 [إصلاح الأخطاء البسيطة](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)

**🟡 متوسط**
- 🔌 إضافة أدوات أو قدرات جديدة لوكلاء الذكاء الاصطناعي
- 📊 تحسين لوحة التحليلات والتصورات
- 🧪 [كتابة الاختبارات](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Atesting)

**🔴 متقدم**
- 🤖 بناء ميزات ذكاء اصطناعي جديدة
- ⚙️ [تحسينات المحرك الأساسي](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Acore)
- 🔐 [ميزات الأمان](https://github.com/studyield/studyield/issues?q=is%3Aissue+is%3Aopen+label%3Asecurity)
...
يُرجى الإبلاغ عن الثغرات الأمنية بمسؤولية. راجع [SECURITY.md](SECURITY.md) لسياسة الإفصاح الخاصة بنا.
...
<p align="center">
  <strong>تم البناء بـ ❤️ من قبل مجتمع <a href="https://github.com/studyield">Studyield</a></strong>
</p>

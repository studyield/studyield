...
<p align="center">
  <img src=".github/screenshots/ai-chat.png" alt="Studyield AI 聊天" width="800">
  <br>
  <em>AI 聊天 -- 基于您上传的学习材料提问，获得带引用的答案</em>
</p>
...
<p align="center">
  <img src=".github/screenshots/problem-solver.png" alt="Studyield 多代理问题解决器" width="800">
  <br>
  <em>多代理问题解决器 -- 分析、解决和验证代理实时协作，分解并验证复杂问题</em>
</p>
...
- 💬 [Discord社区](https://discord.gg/9JEk6WSM) -- 加入我们的Discord服务器
